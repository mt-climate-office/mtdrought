...
![A peach orchard near Grand Junction, Colorado. By midcentury, portions of eastern Montana may feel like western Colorado. Photo: Ronda Kimbrow Photography.](./img/grand_junction.jpg)
...
### <img src="icons/analogs.svg" width="35px"/> Analogs {- .tabset .tabset-fade .tabset-pills}
...
![](./img/analog_map_rcp45.png)

Climate analogs from the [Future Urban Climates](https://www.umces.edu/futureurbanclimates) project, University of Maryland Center for Environmental Science. Research methods published in [Nature Communications](https://www.nature.com/articles/s41467-019-08540-3).

Agricultural statistics from the USDA National Agricultural Statistics Service [2017 Census of Agriculture](https://www.nass.usda.gov/Publications/AgCensus/2017/).

#### Accelerating emissions {-}

![](./img/analog_map_rcp85.png)
