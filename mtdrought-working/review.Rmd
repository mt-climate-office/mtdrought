...
smap <- mtd_plot_smap(date = "2019-05-16",
...
The US Drought Monitor has categorized northwestern Montana as abnormally dry going into early summer. This aligns with the evapotranspiration patterns and precipitation deficits from earlier this spring.
