...
El Niño events can have a strong influence on weather in North America, so NOAA's Climate Prediction Center (CPC) seasonal projections for this spring are in part guided by El Niño conditions. The CPC is projecting that temperatures will likely be warmer across Montana this spring, especially going into April. Warmer temperatures may accelerate spring snowmelt and prompt an earlier start to the growing season.
