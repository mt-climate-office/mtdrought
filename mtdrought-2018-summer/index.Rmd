...
* Montana experienced a cooler and wetter than normal spring that contributed to the delayed onset of melt to our significant winter snowpack.
* Protracted snowmelt contributed to significant recharge of soil moisture and widespread flooding across the state. 
...
* La Niña conditions dissipated to ENSO neutral conditions in late April.
* The summer outlook for temperature is warmer than normal across western and central portions of the state. The forecast is less certain for the remainder of the state.
* The summer outlook for precipitation is drier than normal across northwestern, southwestern, and northcentral portions of the state. The forecast is less certain for the remainder of the state.
* If warmer and drier conditions are realized in western and central regions, there is potential for increased evapotranspiration, drying of soils, and drought.
</div>
