---
title: "Fall/Winter 2019 Forecast"
editor_options: 
...
![Late spring in Ninemile Valley. Cooler than normal temperatures and lots of precipitation has maintained snowpack across much of the northern Rockies. Photo: Ada Smith.](./img/Ada_Smith_Ninemile_Valley.jpg)
...
# enso <- mtd_get_all_enso_ee(start_date = "2019-11-01",
#                                 end_date = "2020-01-31") %T>%
#   readr::write_rds("../data/gridmet/ENSO_NDJ.rds",
#                      compress = "gz")

enso <- readr::read_rds("../data/gridmet/ENSO_NDJ.rds")
...
noaa_seasonal <- mtd_plot_noaa_seasonal_forecast(date = "2019-11-01",
                                                 element = "temp",
