...
Dry conditions continued across the state, with the exception of far eastern Montana. The region around the Crazy mountains received only about 30% of its normal summer precipitation, and the Highwood mountains east of Great Falls received only about 25% of its normal precipitation. This pattern of precipitation continues to be the primary driver of ongoing drought conditions across Montana.
...
smap <- mtd_plot_smap(date = end_date,
...
While satellite-derived soil moisture estimates for the Western Montana continue to be very low, conditions in central and northern Montana have improved as we head into the fall. Soil moisture in northeastern Montana also remains low. Given the climate outlook for the winter, soil moisture conditions should continue to improve across the state.

### ![drought icon](./icons/drought.svg){width="35px"} Drought {-}

```{r past-seasonal-drought, cache=TRUE}

past_seasonal_drought <- mtd_plot_usdm(date = end_date,
                                       data_out = "../data/USDM")
...
Over the summer, abnormally dry and drought conditions expanded across Montana, according to the US Drought Monitor (USDM). Much of western Montana has moderate drought conditions, and portions of northeastern and southeastern Montana are experiencing severe drought. Abnormally warm conditions during early fall have delayed drought recovery that we normally experience in the fall, but La Niña conditions should bring more precipitation as we head into the winter. 
