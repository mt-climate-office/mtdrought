---
title: "June--August, 2018: Current conditions"
editor_options: 
...
gridmet <- mtd_get_gridmet_ee(start_date = "2018-06-01", 
                            end_date = "2018-08-31", 
                            base_name = 'GRIDMET',
                            raw_dir = "../data/GRIDMET",
                            overwrite = TRUE)

climatology_gridmet <- mtd_get_gridmet_climatology_ee(collection = "IDAHO_EPSCOR/GRIDMET", 
                                           vars = c("pr", "tmmn", "tmmx"),
                                           start_date = '1981-01-01', 
                                           end_date = '2011-01-01')

climatology_MACA <- mtd_get_gridmet_climatology_ee(collection = "IDAHO_EPSCOR/MACAv2_METDATA", 
                                           vars = c("pr", "tasmax", "tasmin"),
                                           start_date = '1981-01-01', 
                                           end_date = '2011-01-01')

midcentury_MACA <- mtd_get_gridmet_climatology_ee(collection = "IDAHO_EPSCOR/MACAv2_METDATA", 
                                           vars = c("pr", "tasmax", "tasmin"),
...
gridmet_sf <- gridmet %>%
  ...
  purrr::map(sf::st_intersection,
             y = mt_state_simple)
attr(gridmet_sf,"dates") <- gridmet_dates
...
past_seasonal_swe <- mtd_plot_swe_basins(date="2018-09-01",
                                         huc = 8)
