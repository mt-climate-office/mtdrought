...
# enso <- mtd_get_all_enso_ee(start_date = "2019-06-01",
#                                 end_date = "2019-09-01") %T>%
#   readr::write_rds("../data/gridmet/ENSO_JJA.rds",
#                      compress = "gz")

enso <- readr::read_rds("../data/gridmet/ENSO_JJA.rds")
...
noaa_seasonal <- mtd_plot_noaa_seasonal_forecast(date = "2019-06-01",
                                                 element = "temp",
