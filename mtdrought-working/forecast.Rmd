...
Based on climatological data other than the ENSO status, NOAA's Climate Prediction Center (CPC) is projecting that temperatures are somewhat likely to be warmer than normal across western Montana into early spring (March -- May). This is a fairly weak prediction, however; there is still a chance that temperatures could be cooler than normal. The rest of the state has equal chances of being cooler or warmer than normal.
